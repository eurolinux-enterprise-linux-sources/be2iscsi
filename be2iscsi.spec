%define kmod_name		be2iscsi
%define kmod_driver_version	10.2.273.0r
%define kmod_rpm_release	1
%define kmod_git_hash		96cee23b136ff062218dbce99dbcdf4f60ef8afa
%define kmod_kernel_version	2.6.32-431.el6
%define kernel_version		2.6.32-431.el6
%define kmod_kbuild_dir		drivers/scsi/be2iscsi/
...
%changelog
* Wed Aug 27 2014 Weiping Pan <wpan@redhat.com> 10.2.273.0r 1
- be2iscsi DUP module
